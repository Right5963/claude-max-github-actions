...
function buildAuthHeaders(): { [key: string]: string } {
...
// 年齢認証処理
async function handleAgeVerification(): Promise<boolean> {
  try {
...
async function makeFANZARequest(path: string): Promise<string> {
...
// 検索実行（修正版）
async function searchDoujin(query: string, sort: string = "popular"): Promise<any> {
  try {
...
// ランキング取得（修正版）
async function getRanking(period: string = "daily"): Promise<any> {
  try {
